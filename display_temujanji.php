...
$query = "select * from temujanji";
$result = mysqli_query($con, $query);
//Borang rujukan

if (isset($_GET['dataSelect'])) {

    $id = $_GET['dataSelect'];
    $query2 = "SELECT * FROM temujanji WHERE id=$id";
    $result2 = mysqli_query($con, $query2);
    if ($rows2 = mysqli_fetch_assoc($result2)) {
        $id = $rows2['id'];
        $nama = $rows2['nama'];
        $noPendaftaran = $rows2['noPendaftaran'];
        $kelas = $rows2['kelas'];
        $noTel = $rows2['noTel'];
        $alamat = $rows2['alamat'];
        $tarikh = $rows2['tarikh'];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <br><br><br>
                    <p1 style="color: black; font-size:16px;">Maklumat borang temujanji</p1><b>
                        <br><br>
                        ...
                        <br>
                        <?php
                        echo "<td><button> <a class='button1' href='temujanji_pdf.php? data=$id'>Download PDF</a></button></td>";
                        ?>
                        <br><br><br>
                </div>
                <!-- /.container-fluid -->
