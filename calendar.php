...
function build_calendar($month, $year)
{
    ...
    $calendar .= " <a class='btn btn-xs btn-primary' href='user_main.php'?month='" . date('m') . "' data-year='" . date('Y') . "'>Bulan Semasa</a> ";
    ...
    while ($currentDay <= $numberDays) {
        ...
        if ($date < date('Y-m-d')) {
            ...
            if($totalbookings==3){
                ...
                $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='user_timeslot.php?date=" . $date . "' class='btn btn-success btn-xs'>Tempah</a>";
            }
        }
